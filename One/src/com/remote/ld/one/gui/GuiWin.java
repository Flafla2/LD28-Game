...
public class GuiWin extends GuiMenu {
	...
	public void render(float interpolation)
	{
		...
		Fonts.get("Fipps").drawCenteredString("Health: "+Math.max(GuiInGameOne.health,0), 80, 20, 0x000000);
		Fonts.get("Fipps").drawCenteredString("Money: "+Math.max(GuiInGameOne.money,0), 110, 20, 0x000000);
	}
