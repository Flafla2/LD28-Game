...
public class GuiDead extends GuiMenu {
	...
	public void render(float interpolation)
	{
		...
		Fonts.get("Fipps").drawCenteredString("Ded.", 20, 50, 0xffffff);
		Fonts.get("Fipps").drawCenteredString("Health: "+Math.max(GuiInGameOne.health,0), 80, 20, 0xffffff);
		Fonts.get("Fipps").drawCenteredString("Money: "+Math.max(GuiInGameOne.money,0), 110, 20, 0xffffff);
	}
