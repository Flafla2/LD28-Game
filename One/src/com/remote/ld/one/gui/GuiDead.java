...
public class GuiDead extends GuiMenu {
	...
	public void render(float interpolation)
	{
		...
		Fonts.get("Fipps").drawCenteredString("Health: "+GuiInGameOne.health, 80, 20, 0xffffff);
		Fonts.get("Fipps").drawCenteredString("Money: "+GuiInGameOne.money, 110, 20, 0xffffff);
	}
